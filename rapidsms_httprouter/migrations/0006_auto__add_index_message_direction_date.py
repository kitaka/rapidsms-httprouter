...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Message', fields ['direction', 'date']
        db.create_index(u'rapidsms_httprouter_message', ['direction', 'date'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['direction', 'date']
        db.delete_index(u'rapidsms_httprouter_message', ['direction', 'date'])
    ...
    models = {
        ...
        u'rapidsms_httprouter.message': {
            'Meta': {'object_name': 'Message', 'index_together': "(('direction', 'date'),)"},
